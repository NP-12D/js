...
document.querySelector(".prev").addEventListener("click", function(){
 ...
 function imgslider(){
    slider.style.transform=`translateX(${-imgindex *1000}px)`;
 }
...
let imges=document.querySelectorAll(".slider3 div");
let slider3=document.querySelector(".slider3");
let sw=document.querySelector(".slider-container2").clientWidth;
let le=Math.floor(sw/500);
let totalimg=(imges.length-le);
...
function move() {
 ...
 slider3.style.transform = `translateX(${-index*500}px)`;
